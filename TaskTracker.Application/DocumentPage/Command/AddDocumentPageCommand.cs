...
namespace TaskTracker.Application.Command
{
    ...
    public class AddDocumentPageHandler : AddEntityHandler<TaskTrackerDocumentPage, DocumentPageModel, GetDocumentPageRequest,
        AddDocumentPageRequest, AddDocumentPageCommand>
    {
